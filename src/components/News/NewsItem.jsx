...
const NewsItem = (props) => {
    ...
    return (
        <Card className='bg-dark text-white shadow my-3 border mx-3 position-relative rounded-5' key={id}>
            ...
            <Card.ImgOverlay>
                ...
                <Card.Body className="overflow-auto h-100" >
                    <Link to={shareURL} target="_blank" className="text-decoration-none text-white">
